...
# Khúc này là khai báo các biến cho quá trình làm con AI
...
# AI còn biết gửi mail mà không cần bật gmail á
def send_email(text):
...
# Muốn đi chơi mà sợ trời mưa thì hãy xem dự báo thời tiết 
def current_weather():
